                ...
                <div data-design-id="mission-card-{{ $loop->iteration }}" class="tsr-mission-card">  
                    ...
                    <div class="flex items-start justify-between mb-3">  
                        <div class="flex items-center gap-3">  
                            @if($misi['logo'])
                                <img src="{{ \Illuminate\Support\Facades\Storage::url($misi['logo']) }}" alt="Logo" class="w-11 h-11 rounded-xl object-cover shadow-sm flex-shrink-0">
                            @else
            ...
            <div class="bg-white rounded-2xl shadow-sm" style="border:1px solid #e2e8f0;">  
                ...
                <div data-design-id="app-item-{{ $loop->iteration }}" class="tsr-app-item flex-col sm:flex-row items-start sm:items-center">  
                    ...
                    <div class="flex items-center gap-4 w-full sm:w-auto">
                        {{-- Icon / Logo --}}  
                        @if($app['logo'])
                            <img src="{{ \Illuminate\Support\Facades\Storage::url($app['logo']) }}" alt="Logo" class="w-12 h-12 rounded-2xl object-cover shadow-sm flex-shrink-0">
                        @else
